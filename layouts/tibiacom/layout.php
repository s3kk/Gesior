...
<a href='?subtopic=email'>
  <div id='submenu_email' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
    <div class='LeftChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
    ...
    <div class='SubmenuitemLabel'><font color="lightgreen">Buy Skill</font></div>
    <div class='RightChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
  </div>
</a>
</div>
...
<a href='?subtopic=capturetheflag'>
  <div id='submenu_capturetheflag' class='Submenuitem'
...
activesubmenu.gif);'></div>
	<div class='SubmenuitemLabel'><font color="lightblue">Capture the Flag</font></div>
...
activesubmenu.gif);'></div>
	<div class='SubmenuitemLabel'><font color="red">Zombie Event</font></div>
	<div class='RightChain' style='background-image:url(<?PHP echo $layout_name;
...
<a href='?subtopic=topguilds'>
  <div id='submenu_wars' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
	<div class='LeftChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
	<div id='ActiveSubmenuItemIcon_polls' class='ActiveSubmenuItemIcon' style='background-image:url(<?PHP echo $layout_name; ?>/images/menu/icon-activesubmenu.gif);'></div>
	<div class='SubmenuitemLabel'>Top Guilds</div>
	<div class='RightChain' style='background-image:url(<?PHP echo $layout_name; ?>/images/general/chain.gif);'></div>
  </div>
</a>
</div>
...
<a href='?subtopic=donate'>
  <div id='submenu_doacao' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)'>
    ...
    <div class='SubmenuitemLabel'><blink style=\"color: red;\">Donate</blink></div>
    <div class='RightChain' style='background-image:url(".$layout_name."/images/general/chain.gif);'></div>
  </div>
</a>
...
?>
            Account Maker made by Gesior. Layout by CipSoft GmbH.<br/>Load time: <?PHP echo round($time, 4); ?> seconds
			<br>
...
<br><br><br>
<!-- premium theme box -->
<div id="PremiumBox" class="Themebox" style="background-image:url(http://heromassa.servegame.com/layouts/tibiacom/images/global/themeboxes/premium/premiumbox.gif);">
    <div class="ThemeboxButton" >
    <form action="?subtopic=donate" method="post" style="padding:0px;margin:0px;" ><div class="BigButton" style="background-image:url(http://heromassa.servegame.com/layouts/tibiacom/images/global/buttons/sbutton_green.gif)" ><div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url(http://heromassa.servegame.com/layouts/tibiacom/images/global/buttons/sbutton_green_over.gif);" ></div><input class="ButtonText" type="image" name="Get Premium" alt="Get Premium" src="http://heromassa.servegame.com/layouts/tibiacom/images/global/buttons/_sbutton_getpremium.gif" ></div></div></form>  </div>
  <div class="Bottom" style="background-image:url(http://heromassa.servegame.com/layouts/tibiacom/images/global/general/box-bottom.gif);"></div>
</div>
<div id="fb-root"></div>
...
<div class="fb-page"
data-href="https://www.facebook.com/heromassaserver/"
data-width="195"
...
<blockquote
cite="https://www.facebook.com/heromassaserver/"
class="fb-xfbml-parse-ignore">
<a href="https://www.facebook.com/heromassaserver/">Heromassa Server</a>
</blockquote>
</div>
