...
$config['pagseguro']['email'] = 'kicknclash@gmail.com'; //E-mail da sua conta PagSeguro
...
//Worlds
$config['site']['worlds'] = array(0 => 'LoucoHero');
//Others
...
$config['site']['publickey'] = ""; // Public Key
$config['site']['privkey'] = "";; // Private Key
...
$towns_list[0] = array(1 => 'Sphere'); // list of towns, id => 'name', $towns_list[0] - for world id 0
$towns_list[1] = array(1 => 'Sphere'); // list of towns, id => 'name', $towns_list[1] - for world id 1
...
$config['site']['smtp_host'] = "ssl://mail.gmx.com"; // address
...
$config['site']['players_group_id_block'] = 7; // don't show in statistics players with group ID higher (or equal) then (show tutors, senior tutors and normal players)
